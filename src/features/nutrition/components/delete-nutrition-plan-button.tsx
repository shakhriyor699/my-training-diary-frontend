...
import { deleteNutritionPlan } from "@/src/features/nutrition/api/delete-nutrition-plan";

type DeleteNutritionPlanButtonProps = {
  planId: number;
  redirectHref: string;
...
export function DeleteNutritionPlanButton({
  ...
  const mutation = useMutation({
    mutationFn: () => deleteNutritionPlan(planId),
    onSuccess: () => {
      startTransition(() => {
        setIsOpen(false);
