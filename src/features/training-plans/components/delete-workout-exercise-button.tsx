...
import { deleteWorkoutExercise } from "@/src/features/training-plans/api/delete-workout-exercise";
...
export function DeleteWorkoutExerciseButton({
  exercise,
  triggerClassName,
  labels,
  ...
  const mutation = useMutation({
    mutationFn: () => deleteWorkoutExercise(exercise.id),
    onSuccess: () => {
      startTransition(() => {
        setIsOpen(false);
