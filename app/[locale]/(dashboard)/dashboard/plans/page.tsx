        ...
        <MyTrainingPlansList
          ...
          labels={{
            ...
            create: {
              ...
              gymCoinTitle: t("list.create.gymCoinTitle"),
              gymCoinDescription: t("list.create.gymCoinDescription"),
              gymCoinUnavailable: t("list.create.gymCoinUnavailable"),
              gymCoinInsufficient: t("list.create.gymCoinInsufficient"),
              gymCoinChecking: t("list.create.gymCoinChecking"),
